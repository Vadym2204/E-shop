...
import CategoryInput from "@/app/authorization/inputs/CategoryInput";
import CustomCheckBox from "@/app/authorization/inputs/CustomCheckBox";
import Input from "@/app/authorization/inputs/Input";
import SelectColor from "@/app/authorization/inputs/SelectColor";
import TextArea from "@/app/authorization/inputs/TextArea";
...
const AddProductForm = () => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
      ...
      if (!data.images || data.images.length === 0) {
        setIsLoading(false)
        return toast.error("Mo selected image!")
      }
